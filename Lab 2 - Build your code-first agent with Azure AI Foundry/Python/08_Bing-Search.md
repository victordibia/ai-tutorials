...
1. [Click to create a Grounding with Bing Search Resource](https://portal.azure.com/#view/Microsoft_Azure_Marketplace/GalleryItemDetailsBladeNopdl/id/Microsoft.BingGroundingSearch).
...
For more information, visit the [Grounding with Bing Search](https://learn.microsoft.com/azure/ai-services/agents/how-to/tools/bing-grounding) documentation.
...
1. From your browser, navigate to the [Azure AI Foundry portal](https://ai.azure.com/).
