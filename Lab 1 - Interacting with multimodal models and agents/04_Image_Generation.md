...
1. Navigate to the  **playgrounds**, on the left-hand navigation bar, and select **Try the Images Playground**
...
1. Use the reset button under the **Give the model instructions and context** input field to reset the system message back to default.

![Reset system message](./Images/chat-playground-reset-system-message.png)

1.  Expand the "Add your data" section to check you don't have any data connections to the chat. Use the **Remove data source** button, if needed.
